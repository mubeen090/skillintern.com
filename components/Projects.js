        ...
        <Container>
          <div class="md:w-2/3 lg:w-1/2">
            ...
            <h2 class="my-8 text-2xl font-bold text-gray-700 dark:text-white md:text-4xl">
              Unlock the Power of Technology and Innovation
            </h2>
            <p class="text-gray-600 dark:text-gray-300">
              Explore our cutting-edge projects and discover how technology is
              transforming industries and driving innovation worldwide.
            </p>
          </div>
            ...
            <div class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8">
                ...
                <div class="space-y-2">
                  ...
                  <p class="text-gray-600 dark:text-gray-300">
                    Explore the world of advanced technologies and their impact
                    on society.
                  </p>
                </div>
                <a
            ...
            <div class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8">
                ...
                <div class="space-y-2">
                  ...
                  <p class="text-gray-600 dark:text-gray-300">
                    Discover innovative solutions and their role in shaping the
                    future.
                  </p>
                </div>
                <a
            ...
            <div class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8">
                ...
                <div class="space-y-2">
                  ...
                  <p class="text-gray-600 dark:text-gray-300">
                    Explore projects that make a real impact in various
                    industries.
                  </p>
                </div>
                <a
            ...
            <div class="group relative bg-gray-50 dark:bg-gray-900 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8 transition duration-300 group-hover:bg-white dark:group-hover:bg-gray-800">
                ...
                <div class="space-y-2">
                  ...
                  <p class="text-gray-600 dark:text-gray-300">
                    Stay ahead with the latest advancements in technology and
                    innovation.
                  </p>
                </div>
                <a
